          ...
          <div className='flex flex-col lg:flex-row lg:items-start'>
            ...
            <div className='flex items-center gap-3 lg:ml-auto'>
              {isOwnProfile ? (
                ...
                // 预览模式：显示 Back to Owner View 按钮
                <button
                  onClick={onBackToOwnerViewClick}
                  className='px-4 py-2 rounded-md font-medium transition-colors duration-200 bg-gray-500 text-white hover:bg-gray-600 flex items-center gap-2'
                >
                  <svg
                    className='w-4 h-4'
                    fill='none'
